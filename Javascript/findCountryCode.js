...
// findCountryCode(countries)


// let countryName = "Nepal"

// if(countryName == countries[1].name){
// console.log(countries[1].code);
// }
// else{
//     console.log("Enter correct country name");
// }

// for(let index = 0; index<= (countries.length -1); index++){
//     if(countryName == countries[index].name){
...
//     for(let index = 0; index<= (countries.length -1); index++){
//         if(countryName == countries[index].name){
//             console.log(`The code of ${countryName} is ${countries[index].code}`); 
//         }
//     }
//     console.log("\n");
// }
...
let findCountryCode = (countryName) => {
    for (let index = 0; index <= (countries.length - 1); index++) {
        if (countryName == countries[index].name) {
            console.log(`The code of ${countryName} is ${countries[index].code}`);
        }
